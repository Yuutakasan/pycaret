#!/usr/bin/env python3
"""統合ダッシュボード_fixed_final_v2.ipynbのフォント設定を修正"""
...
print("=" * 70)
print("統合ダッシュボード_fixed_final_v2.ipynbのフォント設定を修正")
print("=" * 70)

try:
    with open('統合ダッシュボード_fixed_final_v2.ipynb', 'r', encoding='utf-8') as f:
    ...
    # 保存
    with open('統合ダッシュボード_fixed_final_v2.ipynb', 'w', encoding='utf-8') as f:
        nbformat.write(nb, f)
    ...
    print("\n" + "=" * 70)
    print("統合ダッシュボード_fixed_final_v2.ipynb修正完了")
    print("=" * 70)
    print("\n💡 この順序が重要:")
